...
# ---------------------------
# [수정/추가 예시]
# - 자동 보정 기능을 넣으려면, tf_callback에서 GT pose나 센서 데이터를 받아서
#   self.T_map_to_base를 실시간으로 갱신하는 코드를 추가해야 함.
# - 예시: /go1_pose_2d_gt 토픽을 구독해서 pose를 받아오고, self.T_map_to_base를 갱신
# ---------------------------
'''