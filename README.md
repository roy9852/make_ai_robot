...
- [CRAIP: Creating Robot Artificial Intelligence Project](#craip-creating-robot-artificial-intelligence-project)
- [📋 Table of Contents](#-table-of-contents)
- [🔧 Prerequisites](#-prerequisites)
- [📦 Packages Overview](#-packages-overview)
  - [1. **go1\_simulation**](#1-go1_simulation)
  - [2. **path\_tracker**](#2-path_tracker)
  - [3. **ros2\_unitree\_legged\_controller**](#3-ros2_unitree_legged_controller)
  - [4. **ros2\_unitree\_legged\_msgs**](#4-ros2_unitree_legged_msgs)
  - [5. **unitree\_guide2**](#5-unitree_guide2)
  - [6. **environment**](#6-environment)
  - [7. **custom\_interfaces**](#7-custom_interfaces)
  - [8. **language\_command\_handler**](#8-language_command_handler)
- [📥 Installation](#-installation)
  - [Step 1: Clone the Repository](#step-1-clone-the-repository)
  - [Step 2: Install Dependencies](#step-2-install-dependencies)
    - [Step 3: Build the Workspace](#step-3-build-the-workspace)
  - [Step 4: Source the Workspace](#step-4-source-the-workspace)
  - [Step 5: Understand the Workspace Structure](#step-5-understand-the-workspace-structure)
- [🚀 Usage](#-usage)
  - [1. Launch Go1 Simulation in Gazebo](#1-launch-go1-simulation-in-gazebo)
    - [Real Time Factor](#real-time-factor)
    - [⚠️ Important Note:](#️-important-note)
  - [2. Visualize pre-built 2D occupancy grid map](#2-visualize-pre-built-2d-occupancy-grid-map)
  - [3. Unitree Guide Controller](#3-unitree-guide-controller)
    - [Keyboard Teleoperation](#keyboard-teleoperation)
  - [4. Path Tracking](#4-path-tracking)
    - [⚠️ Important Note:](#️-important-note-1)
  - [5. Communicate with robot through language](#5-communicate-with-robot-through-language)
- [📝 Final Project:](#-final-project)
  ...
  - [📊 Evaluation: 10 points (absolute evaluation, pass/fail)](#-evaluation-10-points-absolute-evaluation-passfail)
    - [Overview](#overview)
    - [Bag File Description](#bag-file-description)
    - [Task Requirement](#task-requirement)
      - [1. Object Detection](#1-object-detection)
      - [2. Bark Topic Publishing](#2-bark-topic-publishing)
    - [Submission](#submission)
    - [Evaluation Criteria](#evaluation-criteria)
- [⚔️ Competition](#️-competition)
  - [Mission 1: Navigate to the Toilet](#mission-1-navigate-to-the-toilet)
    - [📊 Evaluation:](#-evaluation-1)
  - [Mission 2: Find and Identify Edible Food](#mission-2-find-and-identify-edible-food)
...
- [🏆 Competition Result Video](#-competition-result-video)
- [🏆 Competition Result Table](#-competition-result-table)
- [💡 Helpful Tips for ROS2 Beginners](#-helpful-tips-for-ros2-beginners)
...
- [🔍 Troubleshooting](#-troubleshooting)
  ...
  - [Gazebo Not Found](#gazebo-not-found)
  - [Missing Dependencies](#missing-dependencies)
  - ["Command not found" Error](#command-not-found-error)
  - [Robot Doesn't Walk Well](#robot-doesnt-walk-well)
  - [Robot Doesn't Move](#robot-doesnt-move)
  - [Controller Not Loading](#controller-not-loading)
- [🗺️ Building a New Map](#️-building-a-new-map)
